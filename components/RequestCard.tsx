...
import { DriverCardProps, MarkerData, PassengerRequest } from "@/types/type";
import { formatTime } from "@/libs/utils";
import { colors, fonts } from "@/constants/colors";
import { useDriverStore } from "@/store";

interface Props {
  item: PassengerRequest;
  onPressed?: () => void;
}
export default function RequestCard({ item, onPressed }: Props) {
  return (
    <TouchableOpacity
      onPress={() => {
        if (onPressed) {
    ...
    >
      <Image
        source={{
          uri:
            item?.user!?.profile_image_url! || "https://github.com/shadcn.png",
        }}
